      ...
      <Box sx={{ display: 'flex', minHeight: '100vh' }}>
        ...
        >
          <Routes>
            ...
            <Route path="/tickets/:id/claim" element={<TicketClaim />} />
            ...
            <Route path="/sites/new" element={
              <FormWrapper
                ...
                errorMessage="Error creating site"
                redirectPath="/sites"
              />
            } />
            ...
            <Route path="/sites/:id/edit" element={
              <FormWrapper
                ...
                errorMessage="Error updating site"
                redirectPath="/sites"
                isEdit={true}
              />
            } />
            ...
            <Route path="/equipment/new" element={
              <FormWrapper
                ...
                errorMessage="Error creating equipment"
            ...
            <Route path="/inventory/new" element={
              <FormWrapper
                ...
                errorMessage="Error creating inventory item"
            ...
            <Route path="/shipments/new" element={
              <Box sx={{ p: 3 }}>
                ...
                <FormWrapper
                  ...
                  errorMessage="Error creating shipment"
                  redirectPath="/shipments"
                  additionalProps={{ onClose: () => navigate('/shipments') }}
                />
              </Box>
            } />
            ...
            <Route path="/fieldtechs/new" element={
              <FormWrapper
                FormComponent={FieldTechForm}
                endpoint="/fieldtechs"
                successMessage="Field tech created successfully"
                errorMessage="Error creating field tech"
                redirectPath="/fieldtechs"
              />
            } />
            <Route path="/fieldtechs/:id/edit" element={
              <FormWrapper
                FormComponent={FieldTechForm}
                endpoint="/fieldtechs"
                successMessage="Field tech updated successfully"
                errorMessage="Error updating field tech"
                redirectPath="/fieldtechs"
                isEdit={true}
              />
            } />
