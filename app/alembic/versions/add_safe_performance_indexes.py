"""Add safe performance indexes for frequently queried fields

Revision ID: add_safe_performance_indexes
...
revision = 'add_safe_performance_indexes'
...
def upgrade() -> None:
    ...
    # Ticket indexes - only for columns that exist
    ...
    # Task indexes - only for columns that exist
    ...
    # Inventory indexes - only for columns that exist
...
def downgrade() -> None:
    """Remove safe performance indexes."""
